export default [
  ...
  { inputs: [], name: 'NO_VEST', type: 'error' },
  ...
  },
  {
    ...
    name: 'exit',
    outputs: [
      { internalType: 'uint256', name: 'exitedAmount', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: 'vestID_', type: 'uint256' }],
    name: 'exitVest',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'stbl_', type: 'address' },
      { internalType: 'address', name: 'xStaking_', type: 'address' },
      { internalType: 'address', name: 'revenueRouter_', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address[]', name: 'exemptee', type: 'address[]' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'numOfVests', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
